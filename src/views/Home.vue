                ...
                <div class="accordion-body">
                  ...
                  <button @click="showModal = true,figure_type_selector('square')" title="area square"
                    ...
                    <svg width="20" height="20" class="area-square">
                      <rect width="20" height="20" style="fill:#f8f9fa;stroke-width:3;stroke:#0dcaf0"/>
                      Sorry, your browser does not support inline SVG.
                    </svg>
                  </button>
                  <button @click="showModal = true,figure_type_selector('rectagle')" title="area rectangle"
                          class="btn m-1 btn-outline-info btn-light">
                    <svg width="30" height="20" class="area-rectangle">
                      <rect width="30" height="20" style="fill:#f8f9fa;stroke-width:3;stroke:#0dcaf0"/>
                      Sorry, your browser does not support inline SVG.
                    </svg>
                  </button>
                  <button @click="showModal = true,figure_type_selector('triangle')" title="area triangle"
                          class="btn m-1 btn-outline-info btn-light">
                    <svg height="20" width="20">
                      <polygon points="10,0 0,19 19,19" style="fill:#f8f9fa;stroke-width:2;stroke:#0dcaf0"/>
                      Sorry, your browser does not support inline SVG.
                    </svg>
                  </button>
                  <button @click="showModal = true,figure_type_selector('circle')" title="area circle"
                          class="btn m-1 btn-outline-info btn-light">
                    <svg height="20" width="20">
                      <circle cx="10" cy="10" r="9" style="fill:#f8f9fa;stroke-width:2;stroke:#0dcaf0"/>
                    </svg>
                  </button>
                  <button @click="showModal = true,figure_type_selector('regular_polygon')" title="area regular polygon"
                          class="btn m-1 btn-outline-info btn-light">
                    <svg height="20" width="20">
                      <polygon points="5,0  19, 0  14, 20  0, 20"
                               style="fill:#f8f9fa;stroke-width:2;stroke:#0dcaf0"/>
                      Sorry, your browser does not support inline SVG.
                    </svg>
                  </button>
                  <button @click="showModal = true,figure_type_selector('unregular_polygon')" title="area irregular_polygon"
                          class="btn m-1 btn-outline-info btn-light">
                    <svg height="20" width="20">
